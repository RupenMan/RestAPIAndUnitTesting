...
//				"/students/Student1/courses/Course1").accept(MediaType.APPLICATION_JSON);
//		
...
//	}
	...
	public void createStudentCourse() throws Exception{
		...
		assertEquals("http://localhost:8090/students/Student1/courses/1",response.getHeader(HttpHeaders.LOCATION));
	}
}
